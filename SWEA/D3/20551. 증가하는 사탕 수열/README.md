20551. 증가하는 사탕 수열
[링크](https://swexpertacademy.com/main/talk/solvingClub/problemView.do?contestProbId=AY4XhKTKU0IDFARM&solveclubId=AZvefmuKBurHBIN6&problemBoxTitle=3%EC%9B%94+13%EC%9D%BC+%EB%AC%B8%EC%A0%9C%ED%92%80%EC%9D%B4&problemBoxCnt=4&probBoxId=AZzfz9Ba7-jHBIMr)
문제 내용

시간 : 55개 테스트케이스를 합쳐서 C의 경우 1초 / C++의 경우 1초 / Java의 경우 2초 / Python의 경우 3초
...
각 줄에는 세 개의 자연수 A,B,C (1≤A,B,C≤3000)가 공백 하나를 사이로 두고 주어진다.
